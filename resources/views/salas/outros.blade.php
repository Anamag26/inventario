...
<div>
  ...
  <div class="float-start">
    <h4 class="pb-3">{{$escola->nome}} - Professores e outros </h4>  
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('outros.store') }}" method="POST">
          ...
          <form class="row g-3">
            <div class="col-md-6">
              <label for="nomeoutros" class="form-label">Nome</label>
      ...
      <div class="card mt-3">
        ...
        <div class="card-body">
          ...
          <form action="{{ route('outros.destroy', $outros->id) }}" style="display: inline" method="POST" onsubmit="return confirm('Tem a certeza que quer eliminar esta sala ?')">
            ...
            <p></p>
            Ultima alteração {{$outros->updated_at->format('d-m-y')}}
          </form>
        </div>
      </div>
    </div>
