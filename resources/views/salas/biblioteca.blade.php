    ...
    <nav class="navbar navbar-expand navbar-light">
      <div class="container-fluid">
        ...
        <div class="container-fluid">
         ...
         <form class="d-flex" action="{{ route('biblioteca.index') }}" method="GET">
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalCenterTitle">Criar Maquina</h5>
        ...
        <div class="modal-body">
          <form action="{{ route('biblioteca.store') }}" method="POST">
            ...
            <form class="row g-3">
              ...
              <input type="text" class="form-control" id="nomemaquina" name="nomemaquina"  data-msg="porfavor insira uma maquina valida">
              @error('nomemaquina')
